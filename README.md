...
2. Contributions:
   ...
   -  Ashkan Moghaddassi was responsible for the formulation of the project objectives and the implementation of DeepLabCut on the GPU machine. He wrote Python scripts for color segmentation cropping of the video frames to improve runtime efficiency and labelling accuracy. Files and results can be found in the folder entitled "color_segmentation."
